...
public class TheSwingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Painting painting = connector.retrievePainting("the_swing");
        ...
        if (painting != null) {
            ...
            Toast.makeText(this, "The Swing not found in the database.", Toast.LENGTH_SHORT).show();
        }
        ...
        // go to Liberty Leading The People Activity
        nextPaintingButton.setOnClickListener(v ->
                startActivity(new Intent(this, LibertyLeadingThePeopleActivity.class))
        );
    }
}