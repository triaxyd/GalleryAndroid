...
public class MonaLisaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Painting painting = connector.retrievePainting("mona_lisa");
        ...
        if (painting != null) {
            ...
            Toast.makeText(this, "Mona Lisa not found in the database.", Toast.LENGTH_SHORT).show();
        }
        ...
        //go to Impression Sunrise Activity
        nextPaintingButton.setOnClickListener( l ->
                startActivity(new Intent(this, ImpressionSunriseActivity.class))
        );
